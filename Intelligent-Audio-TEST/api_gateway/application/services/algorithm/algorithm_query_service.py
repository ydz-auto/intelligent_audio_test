...
class AlgorithmQueryService:
    ...
    def list_algorithms():
        ...
        result = algorithm_config_service.list_algorithms(
    ...
    def get_algorithm_options():
        """获取算法选项（下拉框用）"""
        result = algorithm_config_service.get_algorithm_options()
    ...
    def get_algorithm(algo_type: str):
        """获取算法详情"""
        result = algorithm_config_service.get_algorithm(algo_type)
    ...
    def list_params():
        ...
        result = algorithm_config_service.list_params(
    ...
    def get_param(param_id: int):
        """获取参数详情"""
        result = algorithm_config_service.get_param(param_id)
    ...
    def list_mappings():
        ...
        result = algorithm_config_service.list_mappings(
    ...
    def list_case_params():
        ...
        result = algorithm_config_service.list_case_params(
            algorithm_type=algorithm_type,
            scope=scope,
        )
    ...
    def get_case_param(param_id: int):
        """获取单个用例专属参数"""
        result = algorithm_config_service.get_case_param(param_id)
    ...
    def list_reference_params():
        ...
        result = algorithm_config_service.list_reference_params(algorithm_type=algorithm_type)
    ...
    def get_form_schema(algo_type: str):
        ...
        result = algorithm_config_service.get_form_schema(algo_type)
    ...
    def get_algorithm_dimensions(algo_type: str):
        ...
        result = algorithm_config_service.get_algorithm_dimensions(algo_type)
    ...
    def get_dimension_params(dimension_id: int):
        """获取评估维度的参数列表"""
        result = algorithm_config_service.get_dimension_params(dimension_id)
