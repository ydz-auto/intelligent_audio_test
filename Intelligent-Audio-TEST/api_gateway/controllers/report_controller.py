...
from api_gateway.controllers.report_controller_compare import ReportControllerCompare
from api_gateway.controllers.report_controller_secondary import ReportControllerSecondary
...
class ReportController(ReportControllerBase):
    ...
    def get_case_averages_by_filters():
        ...
        try:
            ...
            filtered_case_ids, test_results = ReportController._query_test_cases_and_results(
