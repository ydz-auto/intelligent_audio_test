...
追加导出 session_service 模块的无状态校验函数
（validate_session_status / can_send_message），与 AdapterSelector 并存。
"""
...
from api_adapter_service.domain.services.session_service import (  # noqa: E402,F401
    can_send_message,
