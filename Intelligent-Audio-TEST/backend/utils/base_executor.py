...
from backend.algorithm.algorithm_config_loader import get_config_loader
...
class BaseExecutor:
    ...
    def _validate_and_get_data(self, task_id, tc_rel_id):
        ...
        try:
            ...
            case_algorithm_params = case.algorithm_params or {}
            if case_algorithm_params:
            ...
            result_data = {
                ...
                'case_reference_params': case.reference_params or {},
