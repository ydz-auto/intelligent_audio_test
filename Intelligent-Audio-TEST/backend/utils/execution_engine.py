...
from backend.device_driver import device_driver_factory, register_task_events, unregister_task_events
...
class ExecutionEngine:
            ...
            try:
                ...
                if action == 'stop':
                    ...
                    if action == 'pause':
                        ...
                        from backend.device_driver import get_task_events
                        if get_task_events(task_id) is None:
                            ...
                            from backend.device_driver import register_task_events
    ...
    def _run_task(self, app, task_id, stop_event, pause_event):
        ...
        """
        with app.app_context():
            from backend.models.models import Log, TaskCase
                ...
                while not stop_event.is_set():
                    ...
                    try:
                        ...
                        if task.type == 'e2e':
                            ...
                            from backend.models.models import Device, TaskDevice
