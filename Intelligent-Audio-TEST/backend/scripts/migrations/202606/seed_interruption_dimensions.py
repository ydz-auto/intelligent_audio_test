...
MAIN_DIMENSION = {
    ...
    'params': [
        ...
        ('llm_return_behavior_summary', '回原话题行为分布', '回到原话题行为分类计数', 'json', 'output',
         'interruption.llm_return_behavior_summary', None, 'aux', True,
        ...
        ('llm_return_avg_coherence', '回原话题连贯性均分', '回到原话题回复连贯性均分', 'number', 'output',
         'interruption.llm_return_avg_coherence', None, 'aux', True,
         False, None, '回到原话题后回复连贯性打分均值(0-5)', 104),
        ('llm_return_avg_relevance', '回原话题相关性均分', '回到原话题回复相关性均分', 'number', 'output',
         'interruption.llm_return_avg_relevance', None, 'aux', True,
         False, None, '回到原话题后回复相关性打分均值(0-5)', 105),
        ('llm_return_avg_adaptability', '回原话题适应性均分', '回到原话题回复适应性均分', 'number', 'output',
         'interruption.llm_return_avg_adaptability', None, 'aux', True,
         False, None, '回到原话题后回复适应性打分均值(0-5)', 106),
        ...
        ('llm_return_per_round', '回原话题逐轮行为', '回到原话题逐轮行为', 'json', 'output',
         'interruption.llm_return_per_round', None, 'aux', True,
         False, None, '回到原话题轮的行为判断明细列表', 111),
        ('llm_return_scores_per_round', '回原话题逐轮打分', '回到原话题逐轮打分', 'json', 'output',
         'interruption.llm_return_scores_per_round', None, 'aux', True,
