...
DIMENSIONS = [
    {
        ...
        'params': [
            ...
            ('end_ms', '噪声结束时刻', '噪声结束播放时间(绝对毫秒)', 'number', 'input',
             None, None, None, True,
             False, None, '噪声结束播放的绝对时刻(毫秒 Unix 时间戳)', 11),
            ('pcm_first_ms', 'PCM创建时刻', '模型PCM文件创建时间(绝对毫秒)', 'number', 'input',
             None, None, None, True,
            ...
            ('model_recovery_abs_ms', '恢复回复绝对时刻', '恢复回复绝对世界时刻(ms)', 'number', 'output',
             'model_recovery_abs_ms', None, 'aux', False,
             False, None, '恢复回复的绝对世界时刻(毫秒)', 94),
            # ─── 输出参数: 噪声信息 ───
            ('noise_start_ms', '噪声开始(回传)', '噪声开始时间(回传)', 'number', 'output',
             'noise_start_ms', None, 'aux', False,
             False, None, '噪声开始时间(绝对毫秒，回传)', 95),
            ('noise_end_ms', '噪声结束(回传)', '噪声结束时间(回传)', 'number', 'output',
             'noise_end_ms', None, 'aux', False,
             False, None, '噪声结束时间(绝对毫秒，回传)', 96),
            ('pcm_first_ms_out', 'PCM时刻(回传)', 'PCM创建时刻(回传)', 'number', 'output',
