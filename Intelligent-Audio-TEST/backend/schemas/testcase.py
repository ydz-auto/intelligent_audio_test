...
class TestCaseListItem(APIModel):
    ...
    algorithm_params: Optional[Any] = Field(None, alias='algorithmParams', validation_alias=AliasChoices('algorithm_params', 'algorithmParams'))
    reference_params: Optional[Any] = Field(None, alias='referenceParams', validation_alias=AliasChoices('reference_params', 'referenceParams'))
