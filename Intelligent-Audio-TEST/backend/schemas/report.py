...
class ReportSummarySimplified(APIModel):
    raw_data: List[ReportRawDataGroup] = Field(default_factory=list, alias='rawData', validation_alias='rawData')
    case_categories: List[Any] = Field(default_factory=list, alias='caseCategories', validation_alias='caseCategories')
    all_case_tags: List[Any] = Field(default_factory=list, alias='allCaseTags', validation_alias='allCaseTags')
    resources: List[Any] = Field(default_factory=list, alias='resources', validation_alias='resources')
    resource_headers: List[ReportResourceHeader] = Field(default_factory=list, alias='resourceHeaders', validation_alias='resourceHeaders')
    all_metrics: List[Any] = Field(default_factory=list, alias='allMetrics', validation_alias='allMetrics')
    device_stats: List[Any] = Field(default_factory=list, alias='deviceStats', validation_alias='deviceStats')
    api_stats: List[Any] = Field(default_factory=list, alias='apiStats', validation_alias='apiStats')
    case_type_stats: List[ReportCaseTypeStatGroup] = Field(default_factory=list, alias='caseTypeStats', validation_alias='caseTypeStats')
    devices: List[ReportDeviceInfo] = Field(default_factory=list, alias='devices', validation_alias='devices')
    apis: List[ReportApiInfo] = Field(default_factory=list, alias='apis', validation_alias='apis')
    cases: List[Any] = Field(default_factory=list, alias='cases', validation_alias='cases')
    metric_data: List[ReportMetricByResource] = Field(default_factory=list, alias='metricData', validation_alias='metricData')
    tag_metric_data: List[ReportTagMetricByResource] = Field(default_factory=list, alias='tagMetricData', validation_alias='tagMetricData')
    total_cases: int = Field(0, alias='totalCases', validation_alias='totalCases')
    completed_cases: int = Field(0, alias='completedCases', validation_alias='completedCases')
    failed_cases: int = Field(0, alias='failedCases', validation_alias='failedCases')
...
class ReportDetailData(APIModel):
    ...
    type: str = Field(..., alias='type', validation_alias='type')
    task_id: Optional[int] = Field(None, alias='taskId', validation_alias='taskId')
    task_type: Optional[str] = Field(None, alias='taskType', validation_alias='taskType')
    task_name: str = Field(..., alias='taskName', validation_alias='taskName')
    algorithm_type: Optional[str] = Field(None, alias='algorithmType', validation_alias='algorithmType')
    summary: ReportSummarySimplified = Field(..., alias='summary', validation_alias='summary')
    comparison_data: Optional[Any] = Field(None, alias='comparisonData', validation_alias='comparisonData')
    description: Optional[str] = Field(None, alias='description', validation_alias='description')
    status: str = Field(..., alias='status', validation_alias='status')
