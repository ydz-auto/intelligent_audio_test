...
class DimensionInput(APIModel):
    ...
    agg_denominator: Optional[str] = Field('case', alias='agg_denominator', validation_alias=AliasChoices('agg_denominator', 'aggDenominator'))
    exclude_rounds: Optional[List[int]] = Field(None, alias='exclude_rounds', validation_alias=AliasChoices('exclude_rounds', 'excludeRounds'))
...
class DimensionItem(APIModel):
    ...
    agg_denominator: Optional[str] = Field('case', alias='aggDenominator', validation_alias=AliasChoices('agg_denominator', 'aggDenominator'))
    exclude_rounds: Optional[List[int]] = Field(None, alias='excludeRounds', validation_alias=AliasChoices('exclude_rounds', 'excludeRounds'))
