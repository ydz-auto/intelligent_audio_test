...
from evaluation_service.infrastructure.evaluation_api.api_request_handler import ApiRequestHandler
    ...
    def load_endpoint_configs(self, dimensions):
        ...
        try:
            ...
            for dim in dimensions:
                endpoints = dim.snapshot.api_endpoints if hasattr(dim, 'snapshot') else getattr(dim, 'api_endpoints', [])
