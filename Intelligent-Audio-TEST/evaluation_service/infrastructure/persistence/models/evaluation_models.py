# -*- coding: utf-8 -*-
"""evaluation_service 评估维度 PO 定义

归属：evaluation_service（评估维度上下文）
表：categories / dimensions

P5 改造：从 shared/models/models/evaluation_models.py 真正下沉到本服务。
shared/models/models/evaluation_models.py 改为从这里 re-export。
"""
