...
<style scoped>
.crud-form-modal { padding: 24px; }

.form-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 16px; margin-bottom: 24px; }
...
.form-group-section:last-child { margin-bottom: 0; }
