...
import { useAudioBatchOps } from '../../composables/useAudioBatchOps';
...
export function useAudioImport() {
  ...
  return {
    ...
    showDeleteResultModal: batchOpsModule.showDeleteResultModal,
    deleteResult: batchOpsModule.deleteResult,
    closeDeleteResultModal: batchOpsModule.closeDeleteResultModal,
