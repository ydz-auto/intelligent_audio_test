...
class DeviceAggregate:
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            'max_audio_duration': self.config.get('max_audio_duration'),
            'needs_prompt_audio': self.config.get('needs_prompt_audio'),
            ...
            'status': self.status,
            'last_online_at': self.config.get('last_online_at').isoformat() if self.config.get('last_online_at') else None,
            'created_at': self.config.get('created_at').isoformat() if self.config.get('created_at') else None,
            'updated_at': self.config.get('updated_at').isoformat() if self.config.get('updated_at') else None,
            'supported_algorithms': self.config.get('supported_algorithms') or [],
        }
