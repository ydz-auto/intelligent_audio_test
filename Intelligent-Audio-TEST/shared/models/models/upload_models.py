"""
文件上传任务管理模型 (File Upload Management)

包含上传任务、上传文件、上传分片模型。
"""
from ._base import (
    db, Column, Integer, BigInteger, String, Text, DateTime, JSON,
...
class UploadFile(db.Model):
    ...
    task_id = Column(String(50), comment='关联上传任务ID')
...
class UploadChunk(db.Model):
    ...
    file_id = Column(String(50), comment='关联上传文件ID')
