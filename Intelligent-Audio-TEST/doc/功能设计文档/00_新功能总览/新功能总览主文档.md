...
> 以下链接按功能域分组，评审时可对照本文档逐域查阅详细设计。

| 功能域 | 核心文档 | 配套图表 |
|---|---|---|
| A. 测试执行（含混音/SPL） | [`01_UseCase总览`](../01_测试执行/01_UseCase总览.md) · [`02_架构设计`](../01_测试执行/02_架构设计.md) · [`08_混音与SPL映射`](../01_测试执行/08_混音与SPL映射.md) · [`音频引擎功能总述`](../03_音频处理/音频引擎功能总述.md) | [`混音与SPL映射图`](../01_测试执行/混音与SPL映射图.svg) · [`执行路由流程图`](../01_测试执行/执行路由流程图.svg) · [`Realtime流式推送时序图`](../01_测试执行/Realtime流式推送时序图.svg) |
| B. 任务管理 | [`任务管理`](../02_任务管理/任务管理功能设计文档.md) · [`任务发布`](../02_任务管理/任务发布功能设计文档.md) · [`任务合并`](../02_任务管理/任务合并功能设计文档.md) · [`数据导入导出`](../02_任务管理/任务数据导入导出功能设计文档.md) | [`任务发布流程图`](../02_任务管理/任务发布流程图.svg) · [`任务合并流程图`](../02_任务管理/任务合并流程图.svg) · [`任务状态流转图`](../02_任务管理/任务状态流转图.svg) |
| C. 用例管理 | [`用例管理功能设计文档`](../07_用例管理/用例管理功能设计文档.md) · [`测试用例共用机制`](../07_用例管理/测试用例共用机制文档.md) · [`批量设置评价维度`](../07_用例管理/批量设置评价维度功能设计文档.md) | — |
| D. 报告 + Benchmark | [`报告管理`](../05_报告管理/报告管理功能设计文档.md) · [`报告Benchmark排行`](../05_报告管理/报告Benchmark排行功能设计文档.md) · [`AI增强报告与结果分析`](../05_报告管理/AI增强报告与结果分析功能设计文档.md) · [`对话式报告工作台`](../05_报告管理/对话式报告工作台功能设计文档.md) | [`benchmark排行架构`](../05_报告管理/benchmark_ranking_architecture.svg) · [`AI报告分析架构`](../05_报告管理/ai_report_analysis_architecture.svg) · [`报告工作台架构`](../05_报告管理/report_studio_architecture.svg) |
| E. Agent 化 | [`功能介绍`](../../agent化/01_功能介绍.md) · [`用户场景`](../../agent化/02_用户场景.md) · [`技术设计`](../../agent化/03_技术设计文档.md) | [`功能全景图`](../../agent化/Agent功能全景图.svg) · [`用户场景图`](../../agent化/Agent用户场景图.svg) · [`架构设计图`](../../agent化/Agent架构设计图.svg) |
| F. 微服务化 + 跨区 | V9.7.31 代码库 `docs/微服务.md` · `docs/系统架构.md` · `docs/DDD重构.md` · `docs/09_跨区网络传输方案.md` | V9.7.31 代码库 `docs/svg/01_系统总体架构.svg` · `02_微服务拓扑与端口.svg` · `09_跨区网络传输方案.svg` |
| G. 角色权限 + 登录 | V9.7.31 代码库 `docs/RBAC权限划分.md` · `docs/oauth.md` | V9.7.31 代码库 `docs/svg/04_RBAC角色权限矩阵.svg` · `05_OAuth双模式认证时序.svg` |
| 总览 | [`本主文档`](./新功能总览主文档.md) | [`主架构图V2`](./主架构图V2.svg) |

> 说明：F / G 两域的设计文档位于 V9.7.31 代码库（`D:\00_code\V9.7.31\Intelligent-Audio-TEST\docs\`），未随本仓库同步，评审时请切换到对应代码库查阅。
