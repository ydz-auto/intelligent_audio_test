...
> 本目录采用按能力拆分的任务管理文档结构。已发布任务发布能力已拆分至 [任务发布功能设计文档](任务发布功能设计文档.md)，本文档保留任务管理总设计及既有详细章节。

## 文档索引

| 文档 | 说明 |
| --- | --- |
| [任务发布功能设计文档](任务发布功能设计文档.md) | 日常任务发布为已发布任务、版本、执行和归档 |
| [status_fields_relationship](status_fields_relationship.md) | 任务状态字段关系 |
| [任务合并功能设计文档](任务合并功能设计文档.md) | 任务合并 |
| [任务数据导入导出功能设计文档](任务数据导入导出功能设计文档.md) | 任务数据导入导出 |
