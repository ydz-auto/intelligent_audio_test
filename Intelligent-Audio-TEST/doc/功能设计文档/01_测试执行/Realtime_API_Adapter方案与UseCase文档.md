...
| 4 | [04_类设计.md](04_类设计.md) | BaseAPIAdapter（含 AdapterOutput）、HttpAPIAdapter、RealtimeAPIAdapter（含帧结果/最终结果）、OpenAIRealtimeAdapter、APIAdapterFactory、AudioStreamOrchestrator（编排路由 → RenderAudioFile / RenderAudioStream）、ApiRmsSplMapping、混音流程图、RealtimeSessionExecutor |
