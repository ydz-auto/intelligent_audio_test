...
from ast_demo_en2zh import Config, translate_v4, ProcessResult
...
if __name__ == "__main__":
    ...
    # 目录配置（可自定义）
    INPUT_AUDIO_DIR = r"C:\S2TT\Test_dataset\1210test\en"  # 输入：转换后的音频文件夹（16kHz/16bit/单通道）
    OUTPUT_AUDIO_DIR = r"C:\S2TT\Test_out\1210test-out\en2zh"  # 输出：翻译后的WAV音频
