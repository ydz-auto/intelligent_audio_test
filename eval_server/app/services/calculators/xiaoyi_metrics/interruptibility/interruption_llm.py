...
def evaluate_interruption_llm(per_event: List[Dict[str, Any]],
    ...
    result: Dict[str, Any] = {
        ...
        'first_recovery_coherence': recovery_per_round[0].get('coherence') if recovery_per_round else None,
        'first_recovery_relevance': recovery_per_round[0].get('relevance') if recovery_per_round else None,
        'first_recovery_adaptability': recovery_per_round[0].get('adaptability') if recovery_per_round else None,
        'first_recovery_overall': recovery_per_round[0].get('overall') if recovery_per_round else None,
